...
Nova.booting(function (Vue, router, store) {
  Vue.component('transactions-total', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.prev = 0;
                                queryString = this.formatQueryString(to.query);
                                _context.next = 4;
                                return this.getTotalTransactions(queryString);

                            case 4:
                                this.totalAmount = _context.sent;
                                _context.next = 11;
                                break;
            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.prev = 0;
                            queryString = this.formatQueryString(this.$route.query);
                            _context2.next = 4;
                            return this.getTotalTransactions(queryString);

                        case 4:
                            this.totalAmount = _context2.sent;
                            _context2.next = 11;
                            break;
    ...
    methods: {
        formatQueryString: function formatQueryString(query) {
        ...
        getTotalTransactions: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(queryString) {
                var request, transactions, total;
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                this.loading = true;
                                _context3.next = 3;
                                return axios.get('/nova-api/' + this.card.type + '?' + queryString);
                            ...
                            case 3:
                                ...
                                transactions.resources.forEach(function (resource) {
                                    var amountField = resource.fields.find(function (field) {
            ...
            function getTotalTransactions(_x3) {
    ...
    [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("h1", { staticClass: "text-center text-3xl text-80 font-light" }, [
          _vm._v(
            "Transactions Total: " +
              _vm._s(this.loading ? "calculating ..." : this.totalAmount)
          )
        ])
      ])
    ]
